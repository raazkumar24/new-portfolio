export const socialLinks = [
  ...
  },
  {
    ...
    icon: "FiTwitter", // or "FaXTwitter" if you're using the new logo/icon
    color:
      "hover:text-gray-900 focus:text-gray-900 active:text-gray-900 dark:hover:text-gray-200 dark:focus:text-gray-200 dark:active:text-gray-200",
    size: 24,
  },
  {
    name: "Email",
